...
public:
	...
	static std::string reg32(Register reg){
		switch (reg) {
			case V0: return "$v0";
			case V1: return "$v1";
			case A0: return "$a0";
...
public:
	...
	virtual void genLoadAddrX64(std::ostream& out, Register reg) = 0;
	virtual void genStoreAddrX64(std::ostream& out, Register reg) = 0;
	virtual void genLoadValX64(std::ostream& out, Register reg) = 0;
	virtual void genStoreValX64(std::ostream& out, Register reg) = 0;
	virtual void genLoadAddrMIPS(std::ostream& out, Register reg) = 0;
	virtual void genStoreAddrMIPS(std::ostream& out, Register reg) = 0;
	virtual void genLoadValMIPS(std::ostream& out, Register reg) = 0;
	virtual void genStoreValMIPS(std::ostream& out, Register reg) = 0;
	...
	std::string getReg32(Register reg) {
		return RegUtils::reg32(reg);
	}
...
public:
	...
	virtual void genLoadValX64(std::ostream& out, Register reg) override; 
	virtual void genStoreValX64(std::ostream& out, Register reg) override; 
	virtual void genLoadAddrX64(std::ostream& out, Register reg) override; 
	virtual void genStoreAddrX64(std::ostream& out, Register reg) override{ 
		throw new InternalError("Cannot change the addr of a symOpd");
	}
	virtual void genLoadValMIPS(std::ostream& out, Register reg) override; 
	virtual void genStoreValMIPS(std::ostream& out, Register reg) override; 
	virtual void genLoadAddrMIPS(std::ostream& out, Register reg) override; 
	virtual void genStoreAddrMIPS(std::ostream& out, Register reg) override{ 
		throw new InternalError("Cannot change the addr of a symOpd");
	}
...
public:
	LitOpd(std::string valIn, size_t width, bool isString)
	: Opd(width), val(valIn), isStr(isString) { }
	static LitOpd * buildInt(int val){
		return new LitOpd(std::to_string(val), 8, false);
	}
	static LitOpd * buildBool(bool val){
		if (val){ return new LitOpd("1", 1, false); }
		else { return new LitOpd("0", 1, false); }
	}
...
public:
	...
	virtual void codegenMIPS(std::ostream& out) = 0;
...
public:
	...
	void codegenMIPS(std::ostream& out) override;
...
public:
	...
	void toMIPS(std::ostream& out);
	size_t arSizeX64() const;
	size_t arSizeMIPS() const;
...
private:
	...
	void datagenMIPS(std::ostream& out);
