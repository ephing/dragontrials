...
bool TypeAnalysis::build(ProgramNode* astIn){
	TypeAnalysis * typeAnalysis = new TypeAnalysis();
	typeAnalysis->ast = astIn;

	typeAnalysis->ast->typeAnalysis(typeAnalysis);
	bool noError = !typeAnalysis->hasError;
	delete typeAnalysis;
	return noError;
}
...
void FnDeclNode::typeAnalysis(TypeAnalysis * typing){
	...
	typing->nodeType(this, myID->getSymbol()->getDataType());
	delete formalTypes;
...
void GlobalStmtNode::typeAnalysis(TypeAnalysis* typing) {
	myStmt->typeAnalysis(typing);
}

void GlobalExpNode::typeAnalysis(TypeAnalysis* typing) {
	myExp->typeAnalysis(typing);
}
